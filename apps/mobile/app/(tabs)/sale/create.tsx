...
import type { Customer, Product, Warehouse } from '@/types/models';
...
export default function CreateSaleOrderScreen() {
  ...
  const handleSelectCustomer = (customer: Customer) => {
    ...
    setValue('phone', customer.mobile || customer.phone || '');
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Surface style={styles.section} elevation={1}>
        ...
        <List.Item
          title={selectedCustomer ? '已选择客户' : '选择客户'}
          description={selectedCustomer ? '点击更改' : '必填'}
      ...
      <CustomerSelect
        ...
        onDismiss={() => setShowCustomerSelect(false)}
